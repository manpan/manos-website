...
# Role/position
role: Head of the Cyber R alsosk Lab AssocI alsoate Professor (eq. Reader) of Computer Science
...
- Faculty
---
I am the Founder and Head of the Cyber Risk Lab [(CRL)](https://www.cyberrisklab.co.uk/) at the University of Greenwich. CRL consists of PhD students, junior researchers, research fellows, visiting researchers, and industrial experts. Its research outcomes are in the field of cyber risk capitalising on expertise in multi-agents systems and mathematical optimisation creating AI-powered solutions for optimal risk mitigation. CRL's overarching goal is to invent, develop, and evaluate new models and methods. CRL's impact strategy is to contribute to a more secure UK society against cyber threats. Besides heading CRL, I direct the Cyber Risk Research strategy of the Internet of Things and Security Centre [(ISEC)](https://www.gre.ac.uk/research/groups/isec) acting as its liaison with industrial partners.
